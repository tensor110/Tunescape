      ...
      <div className="stream-holder">
        <div id="stream-container">
          <div id="stream-left">
            ...
            />
            <h1 className="master__name">currentSong?.Title</h1>
            <h1 className="master__artist">currentSong?.Artist</h1>
          </div>
          {/* <svg
        ...
        >
          ...
          <div id="stream-right">
            <StreamCard Song="Count" Artist="Kendrick Lamar" time="5:06" />
            <StreamCard
              Song="Count Me Outtttttttt"
